...
The code heavily uses [`dplyr`](https://cran.r-project.org/web/packages/dplyr) ([vignette](https://cran.r-project.org/web/packages/dplyr/vignettes/introduction.html)) and [`tidyr`](https://cran.r-project.org/web/packages/tidyr) ([vignette](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html)) for data handling and `lattice` for plotting (see `?Lattice`). 
