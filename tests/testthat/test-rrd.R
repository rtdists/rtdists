...
context("rd parameter input (via rrd)")

test_that("parameters == individual parameters:", {
  p1 <- c(1, 0.5, 2, 0.5, 0, 0, 0, 0)
  set.seed(1)
  rrds1 <- rrd(10, parameters = p1)
  set.seed(1)
  rrds2 <- rrd(10, a=1, z=0.5, v=2, t0=0.5, d=0, sz = 0, sv = 0, st0 = 0)
