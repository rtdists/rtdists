...
The code heavily uses [`dplyr`](https://cran.rstudio.com/web/packages/dplyr) ([vignette](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html)) and [`tidyr`](https://cran.rstudio.com/web/packages/tidyr) ([vignette](https://cran.rstudio.com/web/packages/tidyr/vignettes/tidy-data.html)) for data handling and `lattice` for plotting (see `?Lattice`). 
